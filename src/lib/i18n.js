const translations = {
  ko: {
    ...
    startChallenge: '초대하고 시작하기!',
    creating: '생성 중...',

    inviteSent: '초대 완료!',
    inviteSentTo: (email) => `${email}에게 초대 메일을 보냈어요.`,
    inviteSentDesc: '파트너가 메일의 링크를 클릭하면 바로 챌린지에 참여돼요!',
    inviteSentWaiting: '파트너를 기다리는 동안 먼저 시작할 수 있어요',
    goToChallenge: '챌린지로 가기',
    inviteFailed: '초대 메일 발송에 실패했어요. 파트너에게 직접 링크를 공유해주세요.',
    logout: '로그아웃',
  ...
  en: {
    ...
    loginPrompt: 'Start easily with your email',
    ...
    startChallenge: 'Invite & Start!',
    creating: 'Creating...',

    inviteSent: 'Invitation Sent!',
    inviteSentTo: (email) => `Invitation sent to ${email}.`,
    inviteSentDesc: 'Your partner just needs to click the link in their email to join!',
    inviteSentWaiting: 'You can start while waiting for your partner',
    goToChallenge: 'Go to Challenge',
    inviteFailed: 'Failed to send invite email. Please share the link directly with your partner.',
    logout: 'Logout',

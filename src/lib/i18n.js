const translations = {
  ...
  en: {
    title: '30-Day Challe',
    subtitle: 'a challe challe for two ro~',
    googleLogin: 'start with Goo ro',
    orEmail: 'or login with emailo',
    loginPrompt: "let's gogo!!",
    emailPlaceholder: 'emailo addre',
    sendLink: 'get login linko',
    sending: 'sendin sendin...',
    checkEmail: 'check your emailo ro!!',
    sentTo: ' — linko sent ro!',
    clickLink: 'click the linko in your inbox to starto!!',
    tryOther: 'try another emailo ro',
    noAccount: 'no signup ro~ just emailo!',
    invalidEmail: 'check emailo again ro!',
    loading: 'hold on ro...',
    loadingChallenge: 'loadin loadin...',

    newChallenge: 'New Challe ro!',
    invitePartner: 'bring your partno!!',
    me: 'Me',
    partner: 'Partno',
    myName: 'my namo',
    partnerName: "partno's namo",
    partnerEmail: "partno's emailo",
    goalLater: 'goals latero~ no worri ro',
    startChallenge: 'Start Challe!!',
    creating: 'makin makin...',

    challengeCreated: 'challe created ro!!',
    partnerInstructions: (email) => `send this linko to ${email} ro!`,
    partnerInstructionsDesc: 'they login and boom boom, auto-connected ro!!',
    copyLink: 'copy linko',
    linkCopied: 'copied ro!',
    goToChallenge: 'go to challe ro',
    logout: 'logouto',
    ...
    goalPlaceholder: 'what u gonna do for 30 dayso~',
    ...
    today: 'today',
    footerTip: 'tap tap to check in ro · click goal to edito!',
    ...
    milestones: {
      ...
      5:  { icon: '⭐', text: '5 dayso!', sub: 'buildin a habito~' },
      7:  { icon: '🌈', text: 'one weeko!!', sub: 'a whole week ro!!' },
      10: { icon: '🔥', text: '10 dayso!!', sub: 'one-third done ro!!' },
      15: { icon: '🎪', text: 'halfway ro!!', sub: '50% done!! so proudo!!' },
      20: { icon: '🚀', text: '20 days!!', sub: 'just 10 more ro!!' },
      25: { icon: '💎', text: 'almost there ro!!', sub: 'final stretcho!!' },
      28: { icon: '🏃', text: '2 more days!!', sub: 'so close ro!!' },
      30: { icon: '🏆', text: '30 days!!', sub: 'absolu legeno!!' },
    },

    streakLabel: 'streak',
    checkedIn: 'checked in ro!',

    celebTitle: 'amazin amazin!!',
    celebCompleted: '30-day challe complete ro!!',
    celebMsg: "u showed up every single dayo!! incrediblerino!!\nbe proudo of 30 days of efforto ro!!\nhope this habito stays with u forevero!!",
    celebClose: 'keep goin ro!!',

    skinPickerTitle: 'choose skins',
    skinLocked: '🔒 more skins comin soon ro!',
